...
<!-- <script src="https://kit.fontawesome.com/e7271ede2b.js" crossorigin="anonymous"></script> -->
	...
	<body >
		<head>
			<h1 class="text-center text-light">Reporte de Empelados</h1>
		</head>

     <p>Click <a href="{{ route('empleados.excel') }}">Aqui</a> Para descargar en excel </p>
     <p>Click <a href="{{ route('empleados.pdf') }}">Aqui</a> Para descargar en pdf </p>

...
<!-- <script src="https://kit.fontawesome.com/e7271ede2b.js" crossorigin="anonymous"></script> -->
	...
	<body >
		<head>
			<h1 class="text-center text-light">Reporte de Servicios </h1>
		</head>

     <p>Click <a href="{{ route('servicios.excel') }}">Aqui</a> Para descargar en excel </p>
     <p>Click <a href="{{ route('servicios.pdf') }}">Aqui</a> Para descargar en pdf </p>

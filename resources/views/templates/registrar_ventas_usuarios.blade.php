		...
		<div id="main">
			...
			<h2>Nueva Venta</h2>
					...
					<div style="padding: 1%;">
						...
						<input type="hidden" value="{{session('session_id')}}" id="id_usuario" required autocomplete="off">
						
					</div>
					@if($errors->first('id_usuario')) <i>{{$errors -> first ('id_usuario')}}</i>@endif

					<div style="padding: 1%;">
						Escribe tu direccion: <input type="text" name="direccion" value="{{ old('direccion')}}" id="direccion">
					</div>
					...
					<div style="padding: 1%;">
						Cantidad: <input type="number" name="cantidad" value="{{ old('cantidad')}}" id="cantidad"><br>
					</div>
